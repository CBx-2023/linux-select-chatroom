...
\hypersetup{
  ...
  pdfauthor={曹博雄},
  pdfsubject={Linux 高级编程课程设计},
  pdfkeywords={Linux, TCP Socket, select, 多人聊天室, C++}
}
...
\vspace{0.5em}
{\small 作者：曹博雄 \quad 学号：2023102959 \quad 日期：2026 年 7 月}\\
\vspace{0.35em}
{\footnotesize 项目仓库：\url{https://github.com/CBx-2023/linux-select-chatroom}}\\
{\footnotesize GitHub Pages 文档：\url{https://cbx-2023.github.io/linux-select-chatroom/}}\\
\vspace{1.1em}
\end{center}
